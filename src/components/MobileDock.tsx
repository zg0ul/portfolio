        ...
        {navItems.map((item) =>
          item.href ? (
            ...
            <div
              ...
              className={`group/dock text-navy-300 hover:text-neon relative flex h-10 w-10 items-center justify-center text-sm transition-all duration-300 ease-in-out focus-visible:outline-none`}
